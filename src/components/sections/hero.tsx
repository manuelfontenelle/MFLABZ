        ...
        >
          ...
          >
            <div className="inline-flex items-center gap-2 rounded-button bg-secondary/10 px-3 py-1.5 text-[13px] font-semibold text-foreground shadow-xs">
              ...
              <span className="text-muted-foreground">
                <span className="text-foreground">4.9/5</span> from{" "}
                <span className="text-foreground">2500+ clients</span>
              </span>
            </div>
          </motion.div>
          ...
          >
            ...
            <p className="max-w-[760px] text-[clamp(0.95rem,1.4vw,1.16rem)] leading-[1.55] font-medium text-muted-foreground">
              Professional logo design, branding, social media graphics and marketing materials
              crafted to help businesses stand out and grow with confidence.
            </p>
          </motion.div>
          ...
          >
            4.9/5 Rating • 2500+ Verified Reviews • Worldwide Clients
          </motion.p>
        </motion.div>
      </Container>
    </section>
